...
class MediaNotificationManager
    ...
    init {
        ...
        notificationManager = PlayerNotificationManager.Builder(
            ...
            .setChannelNameResourceId(R.string.quizzer_music_player)
            .setChannelDescriptionResourceId(R.string.music_player_for_quizzer_this_plays_background_music_of_current_quiz)
