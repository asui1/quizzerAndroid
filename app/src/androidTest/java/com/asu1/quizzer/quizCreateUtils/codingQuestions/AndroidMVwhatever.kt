...
val androidMVWQuizData = QuizData(
...
@Suppress("unused")
val androidMVWQuizBundle = QuizBundle(
    data = androidMVWQuizData,
...
val androidMVWQuizDataKo = QuizData(
...
@Suppress("unused")
val androidMVWQuizBundleKo = QuizBundle(
    data = androidMVWQuizDataKo,
    theme = androidQuizTheme,
